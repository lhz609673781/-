...
var table=document.createElement("table");
		...
		// lhz.addEvent('shoppingcar','',function(){
		// 	div.style.display="none";
		// })
		
//增加食物订购数量
// var table=lhz.$("shop_table");
// var rows=table.rows;
// var	cells=rows[this].cells;
// 	function addfoodnum(){
// 		var options={
// 			"completeListener":function(){
				
// 					cells[3].innerHTML++;
// 					cells[4].innerHTML=cells[4].innerHTML+cells[2].innerHTML;
// 			}
// 		}
// 		lhz.xssRequest("http://218.196.14.220:8080/res/resorder.action?op=orderJson&num=1&fid=".cells[0],options);

// 	}	


//通过类名取得当前节点
function getNodeByClassName(ele,className) { 
//获取父节点下所有的子节点
	var nodes=ele.childNodes.childNodes;
	//遍历子节点并检查className属性 
