// JavaScript Document
	...
	function listener1(json){
		...
		wq.addEvent("btn5","click",function(){
			...
			for(var i=0;i<obj1.length;i++){
				...
				startimg.style.borderRadius=18+"px";
		...
		for(var j=0;j<inps.length;j++){
			...
			divto.style.border="1px solid #6F3"
					...
					wq.addEvent(find1[index],"click",function(){
						...
						var options={
							...
							if(code==0){
								...
								p2.innerHTML="<span style='color:#C96;font-size:18px;'>"+obj1[index].fname+"</span>"+"<span style='font-size:14px;float:right;padding-right:20px;'>"+date.getFullYear()+"-"+(date.getMonth()+1)+"-"+date.getDate()+"</span>";
	...
	yc.xssRequest("http://218.196.14.220:8080/res/resfood.action?op=findFood&fid="+obj1[index].fid,option);		
						...
						wq.addEvent(find1[index],'mouseout',function(){
							 var divdetail2=wq.$("detaildiv");
							 divdetail2.style.display="none";
							})
	...
	divinfo.style.marginLeft=600+"px";
	...
	span1.style.fontSize=20+"px";
	  
	 var input1=document.createElement("input");
	 input1.type="text";
	 input1.id="input2";
	 span1.innerHTML="送货地址:";
	 var br1=document.createElement("br");
	
	 divinfo.appendChild(span1);
	 divinfo.appendChild(input1);
