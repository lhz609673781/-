...
<link rel="stylesheet" href="<%=basePath%>weixinCss/mineResAdd.css?times=<%=times%>" />
</head>
	...
	<div class="weui-cells weui-cells_form margin-top">
		<div class="weui-cell">
			...
			<div class="weui-cell__bd">
			  <input id="groupName" class="weui-input" type="text" placeholder="请输入项目组名" maxlength="20">
			</div>
		</div>	
	</div>
	<div class='demos-content-padded'>
		<a href="javascript:;" id="showTooltips" class="weui-btn weui-btn_primary" onclick="addRes()">提交</a>
	</div>
</form>
	<!-- 
...
<script>
        function addRes(){
         ...
         $.post('<%=basePath%>weixin/mine/addResGroup.html',{groupName:groupName},function(data){
                   $.toast(data,"text");
