...
<form id="addform" action="<%=basePath%>weixin/addCustom.html" method="post">
	<div class="weui-cells weui-cells_form margin-top">
		...
		<div class="weui-cell">
			...
			<div class="weui-cell__bd">
			  <input class="weui-input" type="text" id="companyName" name="companyName" placeholder="请输入收货客户">
			</div>
		</div>	
		<div class="weui-cell">
			<div class="weui-cell__hd">
			...
			<div class="weui-cell__bd">
			  <input class="weui-input" type="text" id="contacts" name="contacts" placeholder="请输入联系人姓名">
			</div>
		</div>
		<div class="weui-cell">
			<div class="weui-cell__hd">
			...
			<div class="weui-cell__bd">
			  <input class="weui-input" type="tel" id="contactNumber" name="contactNumber" placeholder="请输入联系电话">
			</div>
		</div>
		<div class="weui-cell">
			<div class="weui-cell__hd">
			...
			<div class="weui-cell__bd">
			  <input class="weui-input" type="tel" id="tel" name="tel" placeholder="请输入座机号码">
			</div>
		</div>
		<div class="weui-cell">
			<div class="weui-cell__hd">
			...
			<div class="weui-cell__bd">
			  <input class="weui-input" type="text" id="address" name="address" placeholder="请输入收货地址">
			</div>
		</div>
		<div class="weui-cell project-label-w">
			<div class="weui-cell__hd">
			  <label class="weui-label"><span>*</span>要求到货时间</label>
			</div>
...
<script>
	$("#showTooltips").click(function() {
        ...
        if(contactNumber.length > 0 && !/1[3|4|5|7|8]\d{9}$/.test(contactNumber)){
        	$.toptip('手机号码格式有误');
        	return;
        }
		if(address.length == 0){
