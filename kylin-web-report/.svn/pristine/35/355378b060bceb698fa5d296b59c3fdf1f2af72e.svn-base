...
<body>
			...
			<div class="con-title">
				<div class="fl">
					<p>当前位置：<span>运营部报表查询</span>&gt;
						...
						<i>
							<a class='nav-address' href='javascript:void(0)'><span class='compName'></span>分公司运营</a>
						</i>
					</p>
				</div>
				<div class="fr">
			...
			<div class="layui-tab-content">
							...
							<div class="layui-inline" style='float:left'>
						      ...
						      <div class="layui-input-inline companyName input_label" style='width: 132px;'>
						        <select name="modules" lay-verify="required" class='select-company' lay-search="" id="show_companyName">
						          <option value="" id='default-company'></option>
						        </select>
						      </div>
						    </div>
				...
				<div class="data-content">
					...
					<div class="summary-chart">
						<div class='summary-title'><span class='compName'></span>分公司5个指标维度汇总图</div>
					...
					<div class="ranking-chart">
						<div id="ranking-container" style="width:98%; height:330px; margin: 0 auto;"></div>
					</div>
				</div>
				<div style='position: relative;'>
				<!-- 数据导出按钮 -->
				<button  class='layui-btn layui-btn-warm dataOut' id="branchExcelImpl">数据导出</button>
				<div id='loading'>
	...
	<script type="text/x-jsrender" id="tableExhibition">
		<tr data-uid="">
			...
			<td id="CompanyName" class='projectName detail_page'>
	...
	<script type="text/javascript" src="${staticPath}js/public.js" ></script>
	<script type="text/javascript" src="${staticPath}js/sheet/branchOfficeOperation.js" ></script>
</body>
</html>