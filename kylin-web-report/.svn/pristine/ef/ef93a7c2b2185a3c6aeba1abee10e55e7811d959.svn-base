...
<body>
	...
	<div class="wrap">
		...
		<div class="layui-tab layui-tab-brief content-margin" lay-filter="docDemoTabBrief" id='content'>
			<div class="con-title">
				<div class="fl">
					<p>当前位置：<span>运营部报表查询</span>&gt;<i><a class='nav-address' href='${basePath}views/report/view/sheet/groupOpration.jsp?navId=23'>集团运营</a></i></p>
				</div>
				<div class="fr">
			...
			<div class="layui-tab-content">
				...
				<div class="data-content">
					...
					<div class="summary-chart">
						<div class='summary-title'>集团5个指标维度汇总图</div>
						<div id="summary-container" style="height: 350px; margin: 0 auto">
							<div id='dot-show'>
	...
	<script type="text/x-jsrender" id="SearchTpl">
		<tr data-uid="">
			...
			<td class='projectName detail_page'>
				<span>{{:projectName}}</span>
			</td>
			<td class='companyName detail_page'>
			...
			<td>
				<span>{{:projectRote}}</span>
			</td>
			<td>
				<span>{{:promptRote}}</span>
			</td>
			<td>
				<span>{{:arriclaRote}}</span>
			</td>
			<td>
