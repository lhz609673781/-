...
<body>
	...
	<div class="wrap">
		...
		<div class="layui-tab layui-tab-brief content-margin" lay-filter="docDemoTabBrief" id='content'>
			<div class="con-title">
				<div class="fl">
					<p>当前位置：<span>理赔报表查询</span>&gt;<i>客户理赔对比</i></p>
				</div>
				<div class="fr">
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
							...
							<div class="layui-form-item fl cn">
								...
								<div class="layui-inline check-criteria">
									...
									<div class="layui-input-inline" id="searchType">
										<select name="order-status" id="customer_findtype">
					...
					<div class="charts clearAfter">
						<div class="charts-left fl">
							...
							<div class="charts-item fl">
								...
								<p class="charts-item-value ellipsis"><b id="charts-item5-value">100</b></p>
					...
					<dl class="description">
						...
						<dd>4. 当期赔付总计：<b id="payAmout"></b>万元</dd>
					...
					<!-- 数据导出按钮 -->
					<button id="customer_excel_impl" class='layui-btn layui-btn-warm dataOut'>数据导出</button>
	...
	<script type="text/x-jsrender" id="SearchTpl">
		<tr data-uid="">
			...
			<td id="CompanyName">
				<span class="showCompanySearchCustomName" title={{:customerName}}>{{:customerName}}</span>
			</td>
			<td>
				<span class="showCompanySearchCurrentCompensation">{{:companyName}}</span>
			</td>
			<td>
				<span class="showCompanySearchguestType">{{:guestType}}</span>
			</td>
			<td>
				<span class="showCompanySearchSecond">{{:payAmount}}</span>
			</td>
			<td>
				<span class="showCompanySearchFirst">{{:firstMonthLastSeason}} / {{:secondMonthLastSeason}} / {{:thirdMonthLastSeason}}</span>
			</td>
			<td>
				<span class="showCompanySearchSurroundCompensation">{{:averageLastSeason}}</span>
			</td>
			<td>
				<span class="showCompanySearchSupplierBear">{{:contemporaneousPayment}}</span>
			</td>
			<td>
				<span class="showCompanySearchInsuranceBear">{{:ringPayment}}</span>
			</td>
			<td>
				<span class="showCompanySearchMyBear">{{:carrierPayPercent}}</span>
			</td>
			<td>
				<span class="showCompanySearchMyBear">{{:insurancePayPercent}}</span>
			</td>
			<td>
	...
	<script type="text/javascript" src="${staticPath}js/sheet/clientSeacher.js"></script>
</body>
</html>